...
The last two CSS selectors used in `html_nodes()` were derived using *SelectorGadget* (go to selectorgadget.com to install in your browser).  You might also consider the fun CSS Selector tutorial at http://flukeout.github.io/.  

*Developer Tools* in your browser can also be used to locate the desired content among the hierarchy of HTML tags.
